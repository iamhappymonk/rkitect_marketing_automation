...
- Loads your ICP from brand_alchemy/icp.md or asks 4 questions to define target persona and pain points
...
- Saves the sequence to brand_alchemy/sequences/ and optionally drafts emails in Gmail via Composio
...
Optional: create `brand_alchemy/icp.md` with your target personas, company profile, pain points, and differentiators. If the file does not exist, the skill asks 4 questions before generating.
...
The sequence is saved to `brand_alchemy/sequences/{signal-type}.md`. Each touchpoint includes:
