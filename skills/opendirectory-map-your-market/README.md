...
- Saves output to `brand_alchemy/market-maps/[category]-[date].md` + JSON snapshot
...
Run the skill every quarter. JSON snapshots in `brand_alchemy/market-maps/` let you compare pain cluster rankings over time. A pain that was #3 last quarter and is #1 this quarter is accelerating -- a stronger positioning bet.
