...
- Saves to `brand_alchemy/channel-map/[slug]-[date].md` + JSON snapshot
...
Run the skill every quarter. JSON snapshots in `brand_alchemy/channel-map/` let you track which communities grow or shrink for your ICP over time.
