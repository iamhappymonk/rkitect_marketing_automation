...
```markdown
## Extended Reference
See @brand_alchemy/ai-context/architecture.md for full module map.
See @brand_alchemy/ai-context/testing.md for integration test setup details.
```

Write the referenced files to `brand_alchemy/ai-context/` with the detail that would not fit in 100 lines.
